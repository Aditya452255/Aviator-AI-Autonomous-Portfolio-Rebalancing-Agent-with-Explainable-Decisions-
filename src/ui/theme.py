...
.status-badge-active { background: #065f46; color: #34d399; padding: 4px 12px; border-radius: 9999px; font-size: 0.85rem; font-weight: 600; }
.status-badge-alert { background: #991b1b; color: #fca5a5; padding: 4px 12px; border-radius: 9999px; font-size: 0.85rem; font-weight: 600; }
"""
